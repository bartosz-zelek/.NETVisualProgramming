...
namespace ZelekWieclaw.VisualProgrammingProject.DAO
{
    public class DAOMock : IDataAccessObject
    {
        ...
        private List<IBeerProduct> _beerProducts = new List<IBeerProduct>
         {
             new BeerProduct
                 { Id = 1, ProducerId = 1, Name = "Atak Chmielu", Type = BeerType.Porter, Abv = 6.1f, Ibu = 58 },
             new BeerProduct
             ...
             new BeerProduct
                 { Id = 5, ProducerId = 2, Name = "Mera Porter", Type = BeerType.Stout, Abv = 6.0f, Ibu = 50 },
             new BeerProduct
                 { Id = 6, ProducerId = 3, Name = "Punk Porter", Type = BeerType.Porter, Abv = 5.6f, Ibu = 40 },
             new BeerProduct
                 { Id = 7, ProducerId = 3, Name = "Elvis Juice", Type = BeerType.Porter, Abv = 6.5f, Ibu = 40 },
             ...
             new BeerProduct
                 { Id = 10, ProducerId = 4, Name = "Heineken 0.0", Type = BeerType.Malt, Abv = 0.0f, Ibu = 0 },
             new BeerProduct
